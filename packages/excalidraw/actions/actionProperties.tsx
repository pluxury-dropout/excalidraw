...
export const actionChangeFontSize = register({
  ...
  // tutorgo: вместо четырёх пресетов S/M/L/XL — числовое поле. Значение
  // по-прежнему уходит в perform выше, поэтому вся логика применения размера
  // осталась апстримовой.
